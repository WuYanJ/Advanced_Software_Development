...
<%
    ...
    session.setAttribute("lastPage", "personalInfo.jsp");
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="fa fa-user-circle-o"></i> <%=username%><strong class="caret"></strong></a>
...
//            }
            ...
            <div class="jumbotron">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="list-group">
                            <li class="list-group-item">Username: <%= username %>
                            </li>
            ...
            <div class="row featurette">
                <div class=<%= class1 %>>
                    <h2 class="featurette-heading" style="color: #3c763d"><%=travelImage.getTitle()%>.<span
                            style="color: #99CC00">It'll blow your mind.</span></h2>
                    <p class="lead"><%=travelImage.getDescription()%>
                    </p>
    ...
    <ul class="pagination">
        ...
        %>
        <li class="active"><a href="#"><%=myImagePage.getPageNo()%>
        </a></li>
        <%
